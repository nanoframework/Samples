...
> [!Important]
>
> To access the application managed resources the project has to have to reference `nanoFramework.Runtime.Native` and make sure you have the nanoFramework Resources nuget installed.
