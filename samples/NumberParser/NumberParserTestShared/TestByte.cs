...
{
    public class TestByte : PerformTestBase
    {
        public TestByte()
        {
            TestName = "TestByte";
        ...
        class Test : TestBase
        {
            public Test(string inputString, byte result, bool throwsException = false)
        ...
        {
            return ((byte)value).Equals((byte)expectedValue);
        }
    }
}
